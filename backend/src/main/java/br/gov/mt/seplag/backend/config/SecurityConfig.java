    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/albums/**").hasAnyRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/albums/**").hasAnyRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/albums/**").hasAnyRole("ADMIN")
